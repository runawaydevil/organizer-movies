#!/usr/bin/env python3
"""
Build Release - Movie Organizer v0.01
...
"""
Movie Organizer v0.01 - PyInstaller Spec File
Author: Pablo Murad (runawaydevil)
"""
...
def create_version_info():
    ...
    version_info = '''# UTF-8
#
# Movie Organizer v0.01 - Version Info
# Author: Pablo Murad (runawaydevil)
#
  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'FileVersion', u'0.01'),
        ...
        StringStruct(u'ProductVersion', u'0.01')])
      ]), 
...
copy /Y "API_SETUP.md" "%INSTALL_DIR%\\" 2>nul
copy /Y "CLI_USAGE.md" "%INSTALL_DIR%\\" 2>nul
...
powershell -Command "$WshShell = New-Object -comObject WScript.Shell; $Shortcut = $WshShell.CreateShortcut('%SHORTCUT_PATH%'); $Shortcut.TargetPath = '%INSTALL_DIR%\\MovieOrganizer.exe'; $Shortcut.WorkingDirectory = '%INSTALL_DIR%'; $Shortcut.Description = 'AI-Powered Movie File Organizer v0.01'; $Shortcut.Save()"
...
powershell -Command "$WshShell = New-Object -comObject WScript.Shell; $Shortcut = $WshShell.CreateShortcut('%STARTMENU_SHORTCUT%'); $Shortcut.TargetPath = '%INSTALL_DIR%\\MovieOrganizer.exe'; $Shortcut.WorkingDirectory = '%INSTALL_DIR%'; $Shortcut.Description = 'AI-Powered Movie File Organizer v0.01'; $Shortcut.Save()"

echo 📝 Creating uninstaller...
(
echo @echo off
echo echo Uninstalling Movie Organizer v0.01...
...
echo.
echo 📖 For help with API setup, see: API_SETUP.md
echo 💻 For CLI usage, see: CLI_USAGE.md
echo.
echo Author: Pablo Murad (runawaydevil)
...
REM Movie Organizer v0.01 - Portable Launcher
REM Author: Pablo Murad (runawaydevil)
REM Sets working directory to current folder for PDF reports

echo 🎬 Starting Movie Organizer v0.01...
echo Author: Pablo Murad (runawaydevil)
echo.
...
def create_release_package():
    ...
    # Copy documentation
    docs = ["README.md", "LICENSE", "API_SETUP.md", "CLI_USAGE.md"]
    for doc in docs:
        if Path(doc).exists():
    ...
    release_readme = '''# Movie Organizer v0.01 - Windows Release
...
**Movie Organizer v0.01 - Free Software under MIT License**
'''
...
def main():
    """Main build process"""
    print("🎬 Movie Organizer v0.01 - Release Builder")
